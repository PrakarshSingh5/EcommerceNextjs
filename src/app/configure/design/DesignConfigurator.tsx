...
interface DesignConfiguratorPorps{
    configId:string
    imageUrl:string
    imageDeimensions: {width:number; height:number}
}
const DesignConfigurator=({configId, imageUrl, imageDeimensions}:DesignConfiguratorPorps)=>{
  const {toast}=useToast();
...
const [renderedDim, setRenderedDim]=useState({
  width:imageDeimensions.width / 4,
  heigth:imageDeimensions.height / 4
...
async function saveConfiguration(){
  ...
  try{
      ...
      const actualY=renderedPos.y-containerTop
      ...
      toast({
        title:"Something went wrong",
        description:"There is a problem in saving your config",
        variant:'destructive',
      })
  }
 }
 function base64ToBlob(base64:string, myType:string){
      ...
      return new Blob([byteArray], {type:myType})
 }


    return <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
            <div ref={containerRef} className="relative h-[37.5rem] overflow-hidden col-span-2 2-full
            ...
            fill className="pointer-events-none z-50 select-none"/>
          ...
          <Rnd default={
           { x:150,
            y:205,
            height:imageDeimensions.height / 4,
            width: imageDeimensions.width /4
           }
        ...
        <ScrollArea className='relative flex-1 overflow-auto'>
          ...
          <div className='w-full h-full flex justify-end items-center'>
            <div className='w-full flex gap-6 items-center'>
              ...
              <Button onClick={saveConfiguration} size='sm' className="w-full">Continue
